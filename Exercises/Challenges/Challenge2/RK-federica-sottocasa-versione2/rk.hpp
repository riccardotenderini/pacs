...
{  //! Default max number of iteration: I set it to the number needed by rk23 which is higher than rk45!
  ...
  //type of the step function
  typedef std::function<double (const std::function<double(const double&, const double&)>&, const double&, const double&, const double&, double&)> funType;
